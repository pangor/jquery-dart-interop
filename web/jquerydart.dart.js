...
$$.Object = {"": [],
 ...
 hide$2: function($0, $1) {
  return this.noSuchMethod$1($.createInvocationMirror("hide", "hide$2", 0, [$0, $1], []));
 },
 ...
 _lib3_serializeList$1: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("_serializeList", "_lib3_serializeList$1", 0, [$0], []));
 },
 ...
 _lib3_deserializeHelper$1: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("_deserializeHelper", "_lib3_deserializeHelper$1", 0, [$0], []));
 },
 ...
 _lib3_deserializeRef$1: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("_deserializeRef", "_lib3_deserializeRef$1", 0, [$0], []));
 },
 ...
 _lib3_dispatch$1: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("_dispatch", "_lib3_dispatch$1", 0, [$0], []));
 },
 ...
 _lib3_callback$2: function($0, $1) {
  return this.noSuchMethod$1($.createInvocationMirror("_callback", "_lib3_callback$2", 0, [$0, $1], []));
 },
 ...
 _lib3_deserializeMap$1: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("_deserializeMap", "_lib3_deserializeMap$1", 0, [$0], []));
 },
 ...
 _lib3_deserializeList$1: function($0) {
  return this.noSuchMethod$1($.createInvocationMirror("_deserializeList", "_lib3_deserializeList$1", 0, [$0], []));
 },
...
$$.JSInvocationMirror = {"": ["memberName?", "_internalName", "_kind", "_lib2_arguments", "_namedArgumentNames", "_namedIndices"],
 "super": "Object",
 get$isGetter: function() {
...
;
  var list = [];
  var t1 = this._lib2_arguments;
  if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
    return this.get$positionalArguments$bailout(1, list, t1);
  var t3 = t1.length;
  var t4 = $.get$length(this._namedArgumentNames);
  if (typeof t4 !== 'number')
    throw $.iae(t4);
  var argumentCount = t3 - t4;
 ...
 get$positionalArguments$bailout: function(state0, list, t1) {
  var argumentCount = $.sub($.get$length(t1), $.get$length(this._namedArgumentNames));
  for (var index = 0; $.ltB(index, argumentCount); ++index)
...
;
  ...
  if (typeof map !== 'object' || map === null || (map.constructor !== Array || !!map.immutable$list) && !map.is$JavaScriptIndexingBehavior())
    return this.get$namedArguments$bailout(1, map, 0, 0, 0);
  var t2 = this._namedArgumentNames;
  if (typeof t2 !== 'string' && (typeof t2 !== 'object' || t2 === null || t2.constructor !== Array && !t2.is$JavaScriptIndexingBehavior()))
    return this.get$namedArguments$bailout(2, map, t2, 0, 0);
  var namedArgumentCount = t2.length;
  var t4 = this._lib2_arguments;
  if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior()))
    return this.get$namedArguments$bailout(3, namedArgumentCount, map, t2, t4);
  var t6 = t4.length;
  var namedArgumentsStartIndex = t6 - namedArgumentCount;
  for (var t1 = map.length, i = 0; i < namedArgumentCount; ++i) {
    var t3 = t2[i];
    var t5 = namedArgumentsStartIndex + i;
    if (t5 < 0 || t5 >= t6)
      throw $.ioore(t5);
    t5 = t4[t5];
    if (t3 !== (t3 | 0))
...
;
    ...
    case 2:
      state0 = 0;
      var namedArgumentCount = $.get$length(t2);
      var t4 = this._lib2_arguments;
    case 3:
      state0 = 0;
      var namedArgumentsStartIndex = $.sub($.get$length(t4), namedArgumentCount);
      for (var i = 0; $.ltB(i, namedArgumentCount); ++i)
...
$$._JsSendPortSync = {"": ["_id?"],
 ...
 callSync$1: function(message) {
  ...
  var result = ReceivePortSync.dispatchCall(this._id, serialized);
...
$$._JsSerializer0 = {"": ["_lib3_nextFreeRefId", "_lib3_visited"],
 ...
 visitSendPort$1: function(x) {
  ...
  if (typeof x === 'object' && x !== null && !!x.is$_WorkerSendPort)
    return ['sendport', x._workerId, x._lib3_isolateId, x._receivePortId];
...
$$._Serializer0 = {"": [],
 ...
 visitMap$1: function(map) {
  ...
  return ['map', id, this._lib3_serializeList$1(map.get$keys()), this._lib3_serializeList$1(map.get$values())];
},
...
;      this.position = $.add(this.position, 1);
 ...
 parseString$0: function() {
  ...
  this.position = $.add(this.position, 1);
  var charCodes = $._ListImpl_List(null);
...
;  }
 ...
 token$0: function() {
  for (var t1 = this.json; true;) {
    ...
    if (typeof t2 !== 'number')
      return this.token$0$bailout(1, t1, t2, 0);
    var t4 = $.get$length(this);
    if (typeof t4 !== 'number')
...
;
    ...
    if (token === 32) {
      t2 = this.position;
      if (typeof t2 !== 'number')
        return this.token$0$bailout(4, t1, t2, 0);
      this.position = t2 + 1;
      continue
;    }
    if (token == null)
...
$$.Callback = {"": ["_manualDispose", "_lib1_id?", "_lib1_callback?"],
 ...
 _initialize$1: function(manualDispose) {
  ...
  this._lib1_id = $.add$1($.get$_proxiedObjectTable(), this._lib1_callback);
  $.get$_proxiedObjectTable().globalize$1(this._lib1_id);
},
 Callback$once$1: function(f) {
  this._lib1_callback = new $.anon1(f, this);
...
$$.Proxy = {"": ["_port?", "_lib1_id?"],
 ...
 noSuchMethod$1: function(invocation) {
  var member = invocation.get$memberName();
  var args = invocation.get$positionalArguments();
  if (args == null)
    args = [];
  if (invocation.get$isGetter() === true) {
    if ($.startsWith(member, 'get:') === true)
      member = $.substring$1(member, 4);
    var kind = 'get';
  } else if (invocation.get$isSetter() === true) {
    if ($.endsWith(member, '=') === true)
      member = $.substring$2(member, 0, $.sub($.get$length(member), 1));
    if ($.startsWith(member, 'set:') === true)
      member = $.substring$1(member, 4);
    kind = 'set';
  } else if ($.startsWith(member, 'get:') === true) {
    member = $.substring$1(member, 4);
    kind = 'get';
  } else if ($.startsWith(member, 'set:') === true) {
    member = $.substring$1(member, 4);
    kind = 'set';
  } else
    kind = 'method';
...
$$._FunctionProxy = {"": ["_call", "_port", "_lib1_id"],
 "super": "Proxy",
...
$$._ProxiedObjectTable = {"": ["_name", "_nextId", "_deletedCount", "_registry?", "_port?", "_globalIds", "_handleStack", "_scopeIndices?"],
 ...
 exitScope$0: function() {
  ...
  for (var t1 = this._registry, t2 = this._handleStack, t3 = this._globalIds, i = start; t4 = t2.length, i < t4; ++i) {
    if (i < 0)
      throw $.ioore(i);
 ...
 exitScope$0$bailout: function(state0, start) {
  for (var t1 = this._registry, t2 = this._handleStack, t3 = this._globalIds, i = start; $.ltB(i, t2.length); i = $.add(i, 1)) {
    if (i !== (i | 0))
      throw $.iae(i);
    if (i < 0 || i >= t2.length)
      throw $.ioore(i);
...
$$.main_anon = {"": [],
 "super": "Closure",
 call$0: function() {
  $.context().$$1('#test').hide$2('slow', $.Callback$once(new $.main_anon0()));
}
};
...
$$.main_anon0 = {"": [],
 "super": "Closure",
 call$0: function() {
  $.window().alert$1('The paragraph is now hidden');
}
};
...
$$.anon = {"": ["this_0"],
 ...
 call$1: function(msg) {
  try {
    var receiver = $.index(this.this_0.get$_registry(), $.index(msg, 0));
    var method = $.index(msg, 1);
    var args = $.map($.index(msg, 2), $._deserialize);
    if ($.eqB(method, '#call')) {
      var result = null;
...
$$.anon0 = {"": ["id_1", "port_0"],
 ...
 call$4: function(arg0, arg1, arg2, arg3) {
  ...
  if (!t4)
    ...
    args = t1 ? [arg0] : [];
  var message = [this.id_1, '', 'apply', $.map(args, $._serialize)];
  var result = this.port_0.callSync$1(message);
 ...
 call$4: function(arg1, arg2, arg3, arg4) {
  ...
  try {
    if (arg1_check !== true)
      ...
      return this.f_1.call$1(arg1);
    else if (arg3_check !== true)
      return this.f_1.call$2(arg1, arg2);
    else {
      t1 = arg4_check !== true;
      t2 = this.f_1;
      if (t1)
        return t2.call$3(arg1, arg2, arg3);
      else
        return t2.call$4(arg1, arg2, arg3, arg4);
    }
  } finally {
    $.get$_proxiedObjectTable().invalidate$1(this.this_0.get$_lib1_id());
  }
},
 call$0: function() {
  return this.call$4($,$,$,$)
...
$$.Futures_wait_anon = {"": ["completer_5", "box_0", "values_4", "pos_3", "result_2"],
 "super": "Closure",
 call$1: function(value) {
...
$.Proxy__forward = function(receiver, member, kind, args) {
  ...
  var result = receiver._port.callSync$1([receiver._lib1_id, member, kind, $.map(args, $._serialize)]);
...
;
    ...
    if (t1)
      ...
      if ($.get$_FunctionProxy__map().containsKey$1(message) === true) {
        var proxy = $.index($.get$_FunctionProxy__map(), message);
      ...
      return ['objref', $.add$1($.get$_proxiedObjectTable(), message), $.get$_proxiedObjectTable().get$sendPort()];
  }
};
...
$.Futures_wait = function(futures) {
  ...
  for (var i = 0; i < futures.length; ++i) {
    ...
    future.then$1(new $.Futures_wait_anon(completer, t1, values, i, result));
...
$.CTC13 = new Isolate.$isolateProperties.JSSyntaxRegExp('^[*a-zA-Z0-9]+$', false, false);
...
$.CTC12 = new Isolate.$isolateProperties.JSSyntaxRegExp('^\\[name=["\'][^\'"]+[\'"]\\]$', false, false);
$._getTypeNameOf = null;
...
$.$defineNativeClass('HTMLDocument', {"": ["body?", "documentElement?"],
 ...
 queryAll$1: function(selectors) {
  ...
  } else if ($.CTC13.hasMatch$1(selectors) === true) {
...
;  }
  switch (state0) {
    case 0:
    default:
      if (state0 === 1 || state0 === 0 && $.CTC12.hasMatch$1(selectors) === true)
        switch (state0) {
          case 0:
            var mutableMatches = this.$dom_getElementsByName$1($.substring$2(selectors, 7, selectors.length - 2));
          case 1:
        ...
        switch (state0) {
          case 0:
          case 2:
            if (state0 === 2 || state0 === 0 && $.CTC13.hasMatch$1(selectors) === true)
              switch (state0) {
                case 0:
                  mutableMatches = this.$dom_getElementsByTagName$1(selectors);
                case 2:
...
//@ sourceMappingURL=jquerydart.dart.js.map